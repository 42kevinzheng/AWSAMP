...
function RtlProvider({
  ...
  return (0, import_jsx_runtime3.jsx)(RtlContext.Provider, {
    value: value ?? true,
    ...props
  });
}
...
function createContainer(options = {}) {
  ...
  const Container2 = React23.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime4.jsx)(ContainerRoot, {
        as: component,
        ownerState,
...
function createStack(options = {}) {
  ...
  const Stack2 = React24.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime5.jsx)(StackRoot, {
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className),
...
function createBox(options = {}) {
  ...
  const Box2 = React26.forwardRef(function Box3(inProps, ref) {
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match2, setMatch] = React27.useState(() => {
    if (noSsr && matchMedia) {
...
var PropsContext = React31.createContext(void 0);
...
function useDefaultProps({
  ...
  const ctx = React31.useContext(PropsContext);
...
function useCurrentColorScheme(options) {
  ...
  const [isClient, setIsClient] = React34.useState(noSsr || !isMultiSchemes);
  React34.useEffect(() => {
    setIsClient(true);
  }, []);
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime12.jsxs)(React35.Fragment, {
      children: [(0, import_jsx_runtime12.jsx)(ThemeProvider_default2, {
        themeId: scopedTheme ? themeId : void 0,
        theme: memoTheme,
        children
      }), shouldGenerateStyleSheet && (0, import_jsx_runtime12.jsx)(GlobalStyles, {
  ...
  true ? CssVarsProvider.propTypes = {
     ...
     */
    colorSchemeNode: import_prop_types17.default.any,
    /**
     * localStorage key used to store `colorScheme`
     */
    colorSchemeStorageKey: import_prop_types17.default.string,
    /**
     * The default mode when the storage is empty,
     * require the theme to have `colorSchemes` with light and dark.
     */
    defaultMode: import_prop_types17.default.string,
    /**
     * If `true`, the provider creates its own context and generate stylesheet as if it is a root `CssVarsProvider`.
     */
    disableNestedContext: import_prop_types17.default.bool,
    /**
     * If `true`, the style sheet won't be generated.
     *
     * This is useful for controlling nested CssVarsProvider behavior.
     */
    disableStyleSheetGeneration: import_prop_types17.default.bool,
    /**
     * Disable CSS transitions when switching between modes or color schemes.
     */
    disableTransitionOnChange: import_prop_types17.default.bool,
    /**
     * The document to attach the attribute to.
     */
    documentNode: import_prop_types17.default.any,
    /**
     * The key in the local storage used to store current color scheme.
     */
    modeStorageKey: import_prop_types17.default.string,
    /**
     * If `true`, the mode will be the same value as the storage without an extra rerendering after the hydration.
     * You should use this option in conjuction with `InitColorSchemeScript` component.
     */
    noSsr: import_prop_types17.default.bool,
    /**
     * The window that attaches the 'storage' event listener.
     * @default window
     */
    storageWindow: import_prop_types17.default.any,
    /**
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TJBR2BEZ.js.map
